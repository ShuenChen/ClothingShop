    ...
    <body>
        ...
        <section class="single-product">
            <div class="row">
                    ...
                    <div id="product-slider" class="carousel slide carousel-fade" data-ride="carousel">
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <img src="images/underjogger.png" class="d-block ">
                            </div>
                            <div class="carousel-item">
                                <img src="images/underjogger2.jpg" class="d-block">
                            </div>
                ...
                <div class="col-md-7">
                    ...
                    <h2>UA Sportstyle Terry Joggers</h2>
                    <p>Product code: 4</p>
        ...
        <section class="product-description">
            <div class="container">
                ...
                <p>UA Sportstyle Terry Joggers pants.</p>
            </div>
