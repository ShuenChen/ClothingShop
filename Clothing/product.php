...
<section class="single-product">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="images/pic3.jpg" class="d-block ">
    </div>
    <div class="carousel-item">
      <img src="images/pic1.jpg" class="d-block">
    </div>
    <div class="carousel-item">
      <img src="images/pic2.png" class="d-block">
    </div>
  ...
  <a class="carousel-control-next" href="#product-slider" role="button" data-slide="next">
    ...
    <span class="sr-only">Next</span>
        ...
        <div class="col-md-7">
            ...
            <h2>Adidas Originals NMD R1 'Japan'</h2>
            <p>Product code: 1</p>
...
<section class="product-description">
    <div class="container">
        ...
        <p>Adidas Japan Design NMD. Adidas Japan Design NMD. Adidas Japan Design NMD. Adidas Japan Design NMD.</p>
    </div>
