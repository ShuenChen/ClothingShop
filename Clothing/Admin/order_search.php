...
<html>
	...
	<br>
		...
		<?php
			...
			$sql = "SELECT * from orders t1 inner join orders_items t2 on t1.order_id=t2.order_id inner join products t3 on t2.product_id=t3.product_id WHERE order_name,order_email,order_date,quantity,product_name,product_price LIKE '%$search%'";
